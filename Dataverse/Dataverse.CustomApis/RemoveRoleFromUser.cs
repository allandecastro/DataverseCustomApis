...
{
    public class RemoveRoleFromUser : PluginBase
    {

        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveRoleFromUser" /> class
        /// </summary>
        public RemoveRoleFromUser() : base(typeof(RemoveRoleFromUser))
        {
            RegisteredEvents.Add(
                  new Tuple
                  <MessageProcessingStepStage, string, Action<LocalContext>>(
                       MessageProcessingStepStage.MainOperation, MessageName.dtv_RemoveRoleFromUser, Execute));
