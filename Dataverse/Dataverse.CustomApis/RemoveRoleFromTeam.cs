...
{
    public class RemoveRoleFromTeam : PluginBase
    {

        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveRoleFromTeam" /> class
        /// </summary>
        public RemoveRoleFromTeam() : base(typeof(RemoveRoleFromTeam))
        {
            RegisteredEvents.Add(
                  new Tuple
                  <MessageProcessingStepStage, string, Action<LocalContext>>(
                       MessageProcessingStepStage.MainOperation, MessageName.dtv_RemoveRoleFromTeam, Execute));
                ...
                if (teamEntity != null)
                {
                    ...
                    if (targetRole != null)
                    {
                        ...
                        if (securityRole != null)
                        {
                            ...
                            localContext.OrganizationService.Disassociate(
                              "team",
                              teamReference.Id,
