...
{
    public class RemoveUserFromTeam : PluginBase
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RemoveUserFromTeam" /> class
        /// </summary>
        public RemoveUserFromTeam() : base(typeof(RemoveUserFromTeam))
        {
            RegisteredEvents.Add(
                  new Tuple
                  <MessageProcessingStepStage, string, Action<LocalContext>>(
                       MessageProcessingStepStage.MainOperation, MessageName.dtv_RemoveUserFromTeam, Execute));
        }
